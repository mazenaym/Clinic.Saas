...
public class RejectOnlineBookingCommand
{
    public class Command
    {
        public Guid TenantId { get; set; }
        public Guid BookingId { get; set; }
        public RejectOnlineBookingDto Rejection { get; set; } = null!;
    }
    ...
    public class Handler
    {
        ...
        public async Task<BaseResponse<bool>> Handle(Command command)
        {
            var updated = await _onlineBookingRepository.UpdateStatusAsync(
                command.TenantId,
                command.BookingId,
                OnlineBookingStatus.Rejected,
                command.Rejection.RejectReason);
            ...
            return new BaseResponse<bool>
            {
                Success = true,
                Data = true,
                Message = "Online booking rejected.",
                StatusCode = 200
            };
        }
    }
