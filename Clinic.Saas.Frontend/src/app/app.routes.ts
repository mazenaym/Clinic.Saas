...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'account', canActivate: [clinicRoleGuard(['Admin', 'Doctor', 'Reception'])], loadComponent: () => import('./features/account-settings/account-settings.component').then((m) => m.AccountSettingsComponent) },
      ...
      { path: 'invoices', canActivate: [clinicRoleGuard(['Admin', 'Reception'])], loadComponent: () => import('./features/invoices/invoices.component').then((m) => m.InvoicesComponent) },
      { path: 'invoices/:id', canActivate: [clinicRoleGuard(['Admin', 'Reception'])], loadComponent: () => import('./features/invoices/invoices.component').then((m) => m.InvoicesComponent) },
